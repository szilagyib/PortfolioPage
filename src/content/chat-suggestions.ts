 ...
 *
 * Four, not three: they cover scope, leadership, the thing that makes the
 * work distinctive, and a sign there's a person here — and the chips wrap,
 * so a fourth costs a row at most.
 *
 ...
 *
 * The fun fact stays. It's the one prompt with nothing to prove, and a page
 * that only makes a case reads worse than one that doesn't.
 */
